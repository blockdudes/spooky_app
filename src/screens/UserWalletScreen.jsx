  ...
  return (
    <View className="bg-[#10131A]">
      <SafeAreaView className="flex  bg-[#171A25] h-[100vh]  flex-col space-y-3 ">
        ...
        >
          <Gradient>
            <View className="pl-4 space-y-6 pt-4 shadow-xl">
              {/* //wallet address */}
              <View className="items-center">
                <View className="bg-[#171A25] flex flex-row items-center justify-center px-4 space-x-4 rounded-[30px] w-[220px] h-[55px] ">
                  <Text className="text-white tracking-wider text-lg">{`${userWalletData?.publicAddress.slice(
                    0,
                    6
                  )}...${userWalletData.publicAddress.slice(-6)}`}</Text>
              ...
              <View className="flex flex-row justify-evenly items-center space-x-4">
                <View className="flex flex-col items-center space-y-2">
                  ...
                  <Text className="text-white text-[3vh] ">
                    {parseFloat(ghoBalance).toFixed(4)}
                  </Text>
                </View>
                <View className="flex flex-col items-center space-y-2">
        ...
        <View className="flex flex-col h-[40vh] px-3 gap-3">
          <View className="flex pl-2 flex-row space-x-8 items-center">
            <TouchableOpacity
              className={`${
                activeTab === "Activity" ? "border-b-2 border-[#7264FF]" : ""
              } pb-2`}
              onPress={() => setActiveTab("Activity")}
            >
              <Text className="text-lg tracking-wider  text-white">
                Activity
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              className={`${
                activeTab === "Borrow" ? "border-b-2 border-[#7264FF]" : ""
              } pb-2 `}
